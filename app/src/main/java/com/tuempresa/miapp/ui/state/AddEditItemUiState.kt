...
data class AddEditItemUiState(
    ...
    val horaInicio: String = LocalTime.now().format(DateTimeFormatter.ofPattern("hh:mm a", java.util.Locale.ENGLISH)),
    val turno: String = if(LocalTime.now().hour<12) "AM" else "PM",
